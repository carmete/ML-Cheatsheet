...
\begin{itemize}
	...
	\item Use Coordinates ascent to find $\bm \alpha$. Update one coordinate at a time.
\end{itemize}
...
\begin{itemize}
	...
	\item this weighting is called GloVe (word2vec variant) and creates spatial analogies (nonstreaming)
...
Sparse connections, weight sharing: reduce params.
