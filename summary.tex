...
\begin{itemize}
	...
	\begin{itemize}
		\item[a)] If we want to consider fixed fraction $\alpha$ of points and increase dimension, we need to explore almost whole range in each dimension.
	...
	\begin{itemize}
		\item Optimal classifier:$ f_*(x) = \mathbbm{1}\{\mathbbm{P}[y=1|x] > \frac{1}{2}\}$
...
\end{myalign*}
\item Columns of $\*U$ are called \textbf{principal components} and decorrelate the columns of $\*X$.
